      ...
      <div className="hidden lg:flex lg:w-1/2 bg-zinc-900 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6 max-w-md">
          ...
          <div className="space-y-2">
            ...
            <p className="text-zinc-400 text-lg font-medium">Modern operations hub for SLIIT computing faculty.</p>
          </div>
          <div className="pt-8 grid grid-cols-2 gap-4 text-left">
            <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
              <p className="text-white font-bold text-xl mb-1">12+</p>
              <p className="text-zinc-500 text-xs uppercase font-bold tracking-widest">Active Labs</p>
            </div>
            <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
              <p className="text-white font-bold text-xl mb-1">24/7</p>
              <p className="text-zinc-500 text-xs uppercase font-bold tracking-widest">Support</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 bg-white">
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-zinc-500 font-medium">Sign in to manage campus facilities.</p>
          </div>
